...
def solve_dc_sced(buses, generators, lines):
    """
    buses:
    {
        "Bus1": 100,
    ...
    generators:
    {
        "G1": {"bus":"Bus1","pmin":50,"pmax":300,"cost":20}
    }
    ...
    # Slack bus
    slack_bus = list(buses.keys())[0]
    model.slack = Constraint(expr=model.theta[slack_bus] == 0)
